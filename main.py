...
class PTCPage(wx.Panel):
    def __init__(self, parent):
        ...
        self.ptc_FileText1 = wx.StaticText(self, -1, "最长曝光时间 (s)")
        ...
        self.ptc_FileText7 = wx.StaticText(self, -1, "响应非线性度")
        ...
        self.ptcSizer.Add(self.ptc_FileText3, pos=(2, 0), flag=wx.EXPAND | wx.ALL, border=3)
        self.ptcSizer.Add(self.ptc_FileText4, pos=(2, 1), flag=wx.EXPAND | wx.ALL, border=3)
        self.ptcSizer.Add(self.ptc_FileText5, pos=(2, 2), flag=wx.EXPAND | wx.ALL, border=3)
        self.ptcSizer.Add(self.ptc_FileText6, pos=(4, 0), flag=wx.EXPAND | wx.ALL, border=3)
        self.ptcSizer.Add(self.ptc_FileText7, pos=(4, 1), flag=wx.EXPAND | wx.ALL, border=3)
        self.ptcSizer.Add(self.ptc_textCtrl1, pos=(1, 0), flag=wx.EXPAND | wx.ALL, border=3)
        self.ptcSizer.Add(self.ptc_textCtrl3, pos=(3, 0), flag=wx.EXPAND | wx.ALL, border=3)
        self.ptcSizer.Add(self.ptc_textCtrl4, pos=(3, 1), flag=wx.EXPAND | wx.ALL, border=3)
